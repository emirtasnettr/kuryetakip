 ...
 * İlçe Seeder
 * 
 * Türkiye'nin tüm il ve ilçelerini oluşturur.
 */
class DistrictSeeder extends Seeder
{
    public function run(): void
    {
        $allDistricts = $this->getTurkeyDistricts();

        foreach ($allDistricts as $city => $districts) {
            foreach ($districts as $districtName) {
                District::updateOrCreate(
                    ['name' => $districtName, 'city' => $city],
                    ['name' => $districtName, 'city' => $city, 'is_active' => true]
                );
            }
        }
    }
     ...
     */
    private function getTurkeyDistricts(): array
    {
        return [
