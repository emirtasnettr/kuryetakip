                ...
                <div class="mb-1">
                    ...
                    <div id="shift-menu" class="submenu {{ request()->routeIs('panel.schedule.*') || request()->routeIs('panel.shifts.*') ? '' : 'hidden' }} ml-4 mt-1 space-y-1">
                        <a href="{{ route('panel.schedule.index') }}" 
                           class="flex items-center px-4 py-2 rounded-lg text-sm {{ request()->routeIs('panel.schedule.index') || request()->routeIs('panel.schedule.shifts.page') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
