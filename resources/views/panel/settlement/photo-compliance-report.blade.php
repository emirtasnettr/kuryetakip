...
<div class="mb-6 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
    ...
    <div class="flex flex-wrap items-end gap-2">
        ...
        <a href="{{ route('panel.settlement.photo-compliance-report.export', ['start_date' => $startDate, 'end_date' => $endDate]) }}" class="inline-flex items-center px-4 py-2 bg-green-600 text-white text-sm rounded-lg hover:bg-green-700 ml-2">
